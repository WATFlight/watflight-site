      ...
      {words.map((word, index) => {
        ...
        return (
          <span
            ...
            style={{
              color: isRevealed ? "var(--foreground)" : "oklch(0.22 0.02 245)",
            }}
          >
...
const sideImages = [
  {
    src: "https://images.unsplash.com/photo-1532989029401-439615f3d4b4?w=1200&q=80",
    alt: "Multirotor drone in sky",
    position: "left",
    span: 1,
  },
  {
  ...
  {
    src: "https://images.unsplash.com/photo-1664431398786-aaffcf1c0cee?w=1200&q=80",
    alt: "Fixed-wing UAV in flight",
    position: "right",
    span: 1,
  },
  {
    src: "https://images.unsplash.com/photo-1521405924368-64c5b84bec60?w=1200&q=80",
    alt: "Drone held in hands",
    position: "right",
    span: 1,
  },
];
      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              <Image
                src="https://images.unsplash.com/photo-1514043454212-14c181f46583?w=1920&q=80"
